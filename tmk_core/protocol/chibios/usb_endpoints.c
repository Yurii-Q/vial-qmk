...
#    if defined(USB_ENDPOINTS_ARE_REORDERABLE)
    [USB_ENDPOINT_IN_FAST] = QMK_USB_ENDPOINT_IN_SHARED(USB_EP_MODE_TYPE_INTR, FAST_EPSIZE, FAST_IN_EPNUM, RAW_IN_CAPACITY, NULL, QMK_USB_REPORT_STORAGE_DEFAULT(FAST_EPSIZE)),
#    else
    [USB_ENDPOINT_IN_FAST]      = QMK_USB_ENDPOINT_IN(USB_EP_MODE_TYPE_INTR, FAST_EPSIZE, FAST_IN_EPNUM, RAW_IN_CAPACITY, NULL, QMK_USB_REPORT_STORAGE_DEFAULT(FAST_EPSIZE)),
#    endif
#endif
...
#endif
#if defined(EH_FAST_UPLOAD_ENABLE)
    [FAST_INTERFACE] = USB_ENDPOINT_IN_FAST,
#endif
...
#endif
#if defined(EH_FAST_UPLOAD_ENABLE)
    [USB_ENDPOINT_OUT_FAST] = QMK_USB_ENDPOINT_OUT(USB_EP_MODE_TYPE_INTR, FAST_EPSIZE, FAST_OUT_EPNUM, RAW_OUT_CAPACITY),
#endif
