...
const USB_Descriptor_HIDReport_Datatype_t PROGMEM FastReport[] = {
    HID_RI_USAGE_PAGE(16, RAW_USAGE_PAGE), // Vendor Defined
    HID_RI_USAGE(8, 0x62),         // Vendor Defined
    HID_RI_COLLECTION(8, 0x01),    // Application
        // Data to host
        ...
        HID_RI_LOGICAL_MINIMUM(8, 0x00),
        HID_RI_LOGICAL_MAXIMUM(16, 0x00FF),
        HID_RI_REPORT_COUNT(8, FAST_EPSIZE),
        HID_RI_REPORT_SIZE(8, 0x08),
        HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),
...
#    endif
    ...
    .Fast_Interface = {
        ...
        .InterfaceNumber        = FAST_INTERFACE,
        .AlternateSetting       = 0x00,
        .TotalEndpoints         = 2,
        .Class                  = HID_CSCP_HIDClass,
        .SubClass               = HID_CSCP_NonBootSubclass,
    ...
    .Fast_HID = {
        ...
        .TotalReportDescriptors = 1,
        .HIDReportType          = HID_DTYPE_Report,
        .HIDReportLength        = sizeof(FastReport)
    },
    .Fast_INEndpoint = {
        .Header = {
            .Size               = sizeof(USB_Descriptor_Endpoint_t),
        ...
        .EndpointAddress        = (ENDPOINT_DIR_IN | FAST_IN_EPNUM),
        .Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
        .EndpointSize           = FAST_EPSIZE,
        .PollingIntervalMS      = 0x01
    },
    .Fast_OUTEndpoint = {
        .Header = {
        ...
        .EndpointAddress        = (ENDPOINT_DIR_OUT | FAST_OUT_EPNUM),
        .Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
        .EndpointSize           = FAST_EPSIZE,
        .PollingIntervalMS      = 0x01
    },
...
#ifdef EH_FAST_UPLOAD_ENABLE
                case FAST_INTERFACE:
                    Address = &ConfigurationDescriptor.Fast_HID;
                    Size    = sizeof(USB_HID_Descriptor_HID_t);
