 ...
 * Size: 64 px
 * Bpp: 4
 * Opts: --size 64 --bpp 4 --format lvgl --font lib/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --symbols 0123456789:./- --no-compress --no-kerning --lv-include lvgl.h --lv-font-name eh_font_clock_montserrat_64 -o keyboards/ergohaven/src/display/fonts/eh_font_clock_montserrat_64.c
 ******************************************************************************/
...
#ifndef EH_FONT_CLOCK_MONTSERRAT_64
#define EH_FONT_CLOCK_MONTSERRAT_64 1
#endif

#if EH_FONT_CLOCK_MONTSERRAT_64
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t eh_font_clock_montserrat_64 = {
#else
lv_font_t eh_font_clock_montserrat_64 = {
#endif
...
#endif /*#if EH_FONT_CLOCK_MONTSERRAT_64*/
