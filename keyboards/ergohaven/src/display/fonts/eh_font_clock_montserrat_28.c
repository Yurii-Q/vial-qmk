 ...
 * Size: 28 px
 * Bpp: 4
 * Opts: --size 28 --bpp 4 --format lvgl --font /home/agent/.openclaw/workspace-ben/vial-qmk-4.0.6/lib/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --symbols 0123456789: --no-compress --no-kerning --lv-include lvgl.h --lv-font-name eh_font_clock_montserrat_28 -o ../vial-qmk-4.0.6/keyboards/ergohaven/src/display/fonts/eh_font_clock_montserrat_28.c
 ******************************************************************************/
...
#ifndef EH_FONT_CLOCK_MONTSERRAT_28
#define EH_FONT_CLOCK_MONTSERRAT_28 1
#endif

#if EH_FONT_CLOCK_MONTSERRAT_28
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 299, .box_w = 17, .box_h = 20, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 170, .adv_w = 166, .box_w = 8, .box_h = 20, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 250, .adv_w = 257, .box_w = 16, .box_h = 20, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 410, .adv_w = 256, .box_w = 15, .box_h = 20, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 560, .adv_w = 300, .box_w = 18, .box_h = 20, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 740, .adv_w = 257, .box_w = 16, .box_h = 20, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 900, .adv_w = 276, .box_w = 16, .box_h = 20, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1060, .adv_w = 268, .box_w = 16, .box_h = 20, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1220, .adv_w = 289, .box_w = 16, .box_h = 20, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1380, .adv_w = 276, .box_w = 16, .box_h = 20, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1540, .adv_w = 102, .box_w = 5, .box_h = 15, .ofs_x = 1, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t eh_font_clock_montserrat_28 = {
#else
lv_font_t eh_font_clock_montserrat_28 = {
#endif
