 ...
 * Size: 48 px
 * Bpp: 4
 * Opts: --size 48 --bpp 4 --format lvgl --font /home/agent/.openclaw/workspace-ben/vial-qmk-4.0.6/lib/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --symbols 0123456789: --no-compress --no-kerning --lv-include lvgl.h --lv-font-name eh_font_clock_montserrat_48 -o ../vial-qmk-4.0.6/keyboards/ergohaven/src/display/fonts/eh_font_clock_montserrat_48.c
 ******************************************************************************/
...
#ifndef EH_FONT_CLOCK_MONTSERRAT_48
#define EH_FONT_CLOCK_MONTSERRAT_48 1
#endif

#if EH_FONT_CLOCK_MONTSERRAT_48
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t eh_font_clock_montserrat_48 = {
#else
lv_font_t eh_font_clock_montserrat_48 = {
#endif
...
#endif /*#if EH_FONT_CLOCK_MONTSERRAT_48*/
